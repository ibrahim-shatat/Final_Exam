...
@section('content')
    <div class="card-header">
        ...
        <div></div>
        <a type="submit" class="btn btn-success mb-2" href ="{{ route('companybranches.create') }}" ><i class="fas fa-plus-circle nav-icon"></i> Create New CompanyBranch</a>
    </div>
                ...
                @foreach ($companies as $Company)
                    <tr>
                        ...
                        <td><a type="button" class="btn btn-info"
                                style="margin-right: 5px;"href="{{ route('companybranches.edit', $Company->id) }}">
                                ...
                                style="margin-right: 5px;"href="{{ route('companybranches.show', $Company->id) }}">
